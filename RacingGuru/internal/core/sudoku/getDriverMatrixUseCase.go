...
func generateConditionsDrivers() (models.MatrixDrivers, error) {
	...
	conditions := []models.SudokuCondition{
		...
		{Label: "Больше 50 подиумов", Field: "total_podiums", Op: models.ConditionOperatorGT, Value: 50},
		{Label: "Меньше 10 подиумов", Field: "total_podiums", Op: models.ConditionOperatorLT, Value: 10},
		...
		{Label: "Меньше 100 очков", Field: "total_points", Op: models.ConditionOperatorLT, Value: 100},
